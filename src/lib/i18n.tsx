...
const en: Record<string, string> = {
  ...
  'dash.disasterDetection': 'Disaster Detection',
  'dash.featAlertsDesc': 'Auto-detect disasters with configurable threshold, severity and email alerts',
  'dash.featAlertsTitle': 'Live Disaster Alerts',
  'dash.featChangeDesc': 'Automatic before/after analysis with severity mapping and real-time alerts',
  'dash.featChangeTitle': 'Disaster Change Detection',
  'dash.featColorizeDesc': 'Convert raw IR satellite frames into vivid false-color thermal maps with multiple colormaps',
  'dash.featColorizeTitle': 'IR Colorization',
  'dash.featMultiDesc': 'INSAT-3DS, Sentinel-1, Cartosat-3 and MODIS Terra coverage for India',
  'dash.featMultiTitle': 'Multi-Satellite Support',
  'dash.featQualityDesc': 'PSNR, SSIM, FID and cloud coverage analysis for every processed frame',
  'dash.featQualityTitle': 'Image Quality Metrics',
  'dash.featSceneDesc': 'NDVI vegetation, weather conditions, water bodies and urban heat island detection',
  'dash.featSceneTitle': 'Scene Analysis',
  'dash.heroSubtitle': 'Satellite-first disaster intelligence for emergency responders and decision makers',
  'dash.modulesActive': 'modules active',
  'dash.startAnalysis': 'Start Analysis',
